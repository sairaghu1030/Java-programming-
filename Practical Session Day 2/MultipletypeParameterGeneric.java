public class MultipletypeParameterGeneric<K, V> {
    private K key;
    private V value;
    // Constructor
    public MultipletypeParameterGeneric(K key, V value) {
        this.key = key;
        this.value = value;
    }
...
// Creating a Pair with Integer key and String value
        MultipletypeParameterGeneric<Integer, String> pair1 = new MultipletypeParameterGeneric<>(1, "One");
// Creating a Pair with String key and Double value
        MultipletypeParameterGeneric<String, Double> pair2 = new MultipletypeParameterGeneric<>("PI", 3.14);
